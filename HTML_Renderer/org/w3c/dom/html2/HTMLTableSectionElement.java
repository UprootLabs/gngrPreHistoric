...
public interface HTMLTableSectionElement extends HTMLElement {
   ...
   *          and is relative only to the rows contained inside this section,
   *          not all the rows in the table.
   * @return The newly created row.
   * @exception DOMException
   *              INDEX_SIZE_ERR: Raised if the specified index is greater than
   *              the number of rows of if the index is a negative number other
   *              than -1.
   * @version DOM Level 2
   */
   ...
   *          This index starts from 0 and is relative only to the rows
