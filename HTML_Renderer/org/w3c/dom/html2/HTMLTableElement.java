...
public interface HTMLTableElement extends HTMLElement {
   ...
   * the table. If <code>index</code> is -1 or equal to the number of rows, the
   ...
   * @exception DOMException
   *              INDEX_SIZE_ERR: Raised if the specified index is greater than
   *              the number of rows or if the index is a negative number other
   *              than -1.
   * @version DOM Level 2
   */
   ...
   * 
   * @param index
   *          The index of the row to be deleted. This index starts from 0 and
   ...
   * @exception DOMException
   *              INDEX_SIZE_ERR: Raised if the specified index is greater than
   *              or equal to the number of rows or if the index is a negative
   *              number other than -1.
   * @version DOM Level 2
   */
