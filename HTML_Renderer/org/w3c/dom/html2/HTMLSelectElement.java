...
public interface HTMLSelectElement extends HTMLElement {
   ...
   * <code>insertBefore</code> method on the parent of <code>before</code> in
   * all other cases. This method may have no effect if the new element is not
   * an <code>OPTION</code> or an <code>OPTGROUP</code>.
   * 
   * @param element
   *          The element to add.
   * @param before
   *          The element to insert before, or <code>null</code> for the tail of
   *          the list.
   * @exception DOMException
