...
public interface HTMLTableRowElement extends HTMLElement {
   ...
   * <code>rowIndex</code> does take into account sections ( <code>THEAD</code>,
   * <code>TFOOT</code>, or <code>TBODY</code>) within the table, placing
   * <code>THEAD</code> rows first in the index, followed by <code>TBODY</code>
   * rows, followed by <code>TFOOT</code> rows.
   * 
   * @version DOM Level 2
   */
   ...
   *              greater than the number of cells or if the index is a negative
   *              number other than -1.
   * @version DOM Level 2
   */
