...
public interface HTMLInputElement extends HTMLElement {
   ...
   * interactive user agent, changes. See the checked attribute definition in
   * HTML 4.01.
   */
   ...
   * or "checkbox", this represents the current state of the form control, in an
   ...
   * value of the HTML value attribute of the element. When the
   ...
   * <code>type</code> attribute has one of the following values: "text",
   * "file", or "password".
   */
  public void select();
