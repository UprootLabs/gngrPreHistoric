...
public class SimpleUserAgentContext implements UserAgentContext {
  ...
  /**
   * Creates a {@link org.lobobrowser.html.test.SimpleHttpRequest} instance. The
   * {@link org.lobobrowser.html.HttpRequest}</code> object returned by this
  ...
  /**
   * Returns the application "code name." This implementation returns the value
   * of a local field.
   * 
  ...
  public void setCookie(final java.net.URL url, final String cookieSpec) {
    ...
    final Map<String, List<String>> headers = new HashMap<>(2);
  ...
  /**
   * Gets the Rhino optimization level. This implementation returns the value of
   * a local field defaulting to <code>-1</code>.
   * 
