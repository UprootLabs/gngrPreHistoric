...
public final class DomainValidation {
   ...
   *
   * @param domain  The domain to check. Expected <b>not</b> to have any leading or trailing '.'
  ...
  /** Returns a collection of domains that are acceptable for cookies originating from the given hostname */
