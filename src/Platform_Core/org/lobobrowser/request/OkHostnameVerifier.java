...
public final class OkHostnameVerifier implements HostnameVerifier {
  ...
  public static boolean verify(String host, X509Certificate certificate) {
   ...
   */
  private static boolean verifyIpAddress(String ipAddress, X509Certificate certificate) {
   ...
   */
  private static boolean verifyHostName(String hostName, X509Certificate certificate) {
